...
const navigation: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Auditoría', href: '/auditoria', icon: IconHistory, permission: 'system_admin' },
    ],
  },
  {
    title: 'Configuración',
                    ...
                    <li key={item.name}>
                      ...
                      >
                        ...
                        {isActive && shouldShowText && (
                          <IconChevronRight size={14} className="text-white shrink-0 transition-transform duration-200 group-hover:translate-x-1" strokeWidth={2.5} />
                        )}
                      </Link>
                    </li>
                  );
